...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .setup, .command = "/setup", .help_entry = "/setup [custom]", .completion_description = "manage accounts and custom provider access", .presentation_category = .account, .show_in_welcome = true, .has_args = true, .accepts_payload = true },
