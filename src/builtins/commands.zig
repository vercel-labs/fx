...
pub const top_level_specs = [_]TopLevelSpec{
    ...
    .{
        .kind = .login,
        .token = "login",
        .usage = "login [vercel|chatgpt|grok]",
    ...
    .{
        .kind = .logout,
        .token = "logout",
        .usage = "logout [vercel|chatgpt|grok]",
        .summary = "Sign out of a Vercel, ChatGPT, or Grok session",
        .details = &.{
    ...
    .{
        .kind = .setup,
        .token = "setup",
        .usage = "setup [openai-compatible|chatgpt|grok]",
...
pub const top_level_help_groups = [_]TopLevelHelpGroup{
    ...
    .{ .entries = &.{
        .{ .kind = .login, .usage = "login [vercel|chatgpt|grok]" },
        .{ .kind = .logout, .usage = "logout [vercel|chatgpt|grok]" },
        .{ .kind = .setup, .usage = "setup [openai-compatible|chatgpt|grok]" },
...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .login, .command = "/login", .help_entry = "/login [vercel|chatgpt|grok]", .completion_description = "sign in with Vercel, ChatGPT, or Grok", .presentation_category = .account, .has_args = true, .accepts_payload = true },
    .{ .kind = .logout, .command = "/logout", .help_entry = "/logout [vercel|chatgpt|grok]", .completion_description = "sign out of Vercel, ChatGPT, or Grok", .presentation_category = .account, .has_args = true, .accepts_payload = true },
    .{ .kind = .setup, .command = "/setup", .help_entry = "/setup", .completion_description = "set up AI Gateway, ChatGPT, Grok, or OpenAI-compatible access", .presentation_category = .account },
