...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .revert, .command = "/revert", .help_entry = "/revert", .completion_description = "edit an earlier message in this session", .presentation_category = .session },
    .{ .kind = .unrevert, .command = "/unrevert", .help_entry = "/unrevert", .completion_description = "restore the reverted conversation", .presentation_category = .session },
