...
pub const top_level_specs = [_]TopLevelSpec{
    ...
    .{
        .kind = .login,
        .token = "login",
        .usage = "login [vercel|chatgpt]",
        .summary = "Sign in with Vercel or a ChatGPT subscription",
        .details = &.{
    ...
    .{
        .kind = .logout,
        .token = "logout",
        .usage = "logout [vercel|chatgpt]",
        .summary = "Sign out of a Vercel or ChatGPT session",
        .details = &.{
    ...
    .{
        .kind = .setup,
        .token = "setup",
        .usage = "setup [openai-compatible|chatgpt]",
        .summary = "Configure an AI Gateway key, OpenAI-compatible URL, or ChatGPT login",
        .details = &.{
...
pub const top_level_help_groups = [_]TopLevelHelpGroup{
    ...
    .{ .entries = &.{
        .{ .kind = .login, .usage = "login [vercel|chatgpt]" },
        .{ .kind = .logout, .usage = "logout [vercel|chatgpt]" },
        .{ .kind = .setup, .usage = "setup [openai-compatible|chatgpt]" },
...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .login, .command = "/login", .help_entry = "/login [vercel|chatgpt]", .completion_description = "sign in with Vercel or ChatGPT", .presentation_category = .account, .has_args = true, .accepts_payload = true },
    .{ .kind = .logout, .command = "/logout", .help_entry = "/logout [vercel|chatgpt]", .completion_description = "sign out of Vercel or ChatGPT", .presentation_category = .account, .has_args = true, .accepts_payload = true },
    .{ .kind = .setup, .command = "/setup", .help_entry = "/setup", .completion_description = "set up AI Gateway, ChatGPT, or OpenAI-compatible access", .presentation_category = .account },
