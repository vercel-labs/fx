...
pub const top_level_specs = [_]TopLevelSpec{
    ...
    .{
        ...
        .summary = "Sign in to Vercel, Codex, or Grok",
    },
    .{
        .kind = .logout,
        .token = "logout",
        .usage = "logout [vercel|codex|grok]",
        .summary = "Sign out of a Vercel, Codex, or Grok session",
    },
    .{
        .kind = .setup,
        .token = "setup",
        .usage = "setup [gateway|opencode]",
        .summary = "Configure Gateway or OpenCode Go access",
    },
    .{
        .kind = .status,
        .token = "status",
...
pub const top_level_help_groups = [_]TopLevelHelpGroup{
    ...
    .{ .entries = &.{
        ...
        .{ .kind = .setup, .usage = "setup [gateway|opencode]" },
...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .login, .command = "/login", .help_entry = "/login", .completion_description = "choose Vercel, Codex, or Grok sign-in", .presentation_category = .account },
    ...
    .{ .kind = .setup, .command = "/setup", .help_entry = "/setup", .completion_description = "manage accounts, API keys, and provider access", .presentation_category = .account },
