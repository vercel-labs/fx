...
pub const top_level_specs = [_]TopLevelSpec{
    ...
    .{
        .kind = .login,
        .token = "login",
        .usage = "login [vercel|chatgpt|grok|cursor]",
        .summary = "Sign in with Vercel or a subscription backend",
        .details = &.{
            "With no arguments, sign in with Vercel.",
            "Use `chatgpt` for ChatGPT subscription OAuth.",
            "Use `grok` for Grok Build / SuperGrok subscription OAuth.",
            "Use `cursor` for Cursor subscription OAuth.",
        },
    },
    .{
        .kind = .logout,
        .token = "logout",
        .usage = "logout [vercel|chatgpt|grok|cursor]",
        .summary = "Sign out of a Vercel, ChatGPT, Grok, or Cursor session",
        .details = &.{
            "With no arguments, sign out of Vercel.",
            "Use `chatgpt` to delete the ChatGPT session under ~/.fx/providers/chatgpt/.",
            "Use `grok` to delete the Grok session under ~/.fx/providers/grok/.",
            "Use `cursor` to delete the Cursor session under ~/.fx/providers/cursor/.",
        },
    },
    .{
        .kind = .setup,
        .token = "setup",
        .usage = "setup [openai-compatible|chatgpt|grok|cursor]",
        .summary = "Configure an AI Gateway key, OpenAI-compatible URL, or subscription login",
        .details = &.{
            "With no arguments, paste an AI Gateway API key.",
            "Use `openai-compatible` to save a Chat Completions base URL and API key.",
            "Use `chatgpt` to sign in with a ChatGPT subscription.",
            "Use `grok` to sign in with a Grok Build / SuperGrok subscription.",
            "Use `cursor` to sign in with a Cursor subscription.",
        },
    },
    .{
        .kind = .status,
...
pub const top_level_help_groups = [_]TopLevelHelpGroup{
    ...
    .{ .entries = &.{
        .{ .kind = .login, .usage = "login [vercel|chatgpt|grok|cursor]" },
        .{ .kind = .logout, .usage = "logout [vercel|chatgpt|grok|cursor]" },
        .{ .kind = .setup, .usage = "setup [openai|chatgpt|grok|cursor]" },
...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .login, .command = "/login", .help_entry = "/login [vercel|chatgpt|grok|cursor]", .completion_description = "sign in with Vercel, ChatGPT, Grok, or Cursor", .presentation_category = .account, .has_args = true, .accepts_payload = true },
    .{ .kind = .logout, .command = "/logout", .help_entry = "/logout [vercel|chatgpt|grok|cursor]", .completion_description = "sign out of Vercel, ChatGPT, Grok, or Cursor", .presentation_category = .account, .has_args = true, .accepts_payload = true },
    .{ .kind = .setup, .command = "/setup", .help_entry = "/setup", .completion_description = "set up AI Gateway, ChatGPT, Grok, Cursor, or OpenAI-compatible access", .presentation_category = .account },
