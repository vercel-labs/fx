...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .fork_session, .command = "/fork", .help_entry = "/fork [title]", .completion_description = "fork the current session", .presentation_category = .session, .has_args = true, .accepts_payload = true },
