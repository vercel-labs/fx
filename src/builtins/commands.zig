...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .setup, .command = "/setup", .help_entry = "/setup [custom]", .completion_description = "manage accounts and custom provider access", .presentation_category = .account, .has_args = true, .accepts_payload = true },
