...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .swarm, .command = "/swarm", .help_entry = "/swarm [job-id|findings]", .completion_description = "show Puppetmaster swarm status and recent artifacts", .presentation_category = .agents, .has_args = true, .accepts_payload = true },
