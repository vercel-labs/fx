...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .reasoning, .command = "/reasoning", .help_entry = "/reasoning [on|off]", .completion_description = "show model reasoning while it streams", .presentation_category = .appearance, .has_args = true, .accepts_payload = true },
