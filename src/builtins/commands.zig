...
pub const top_level_specs = [_]TopLevelSpec{
    ...
    .{
        .kind = .login,
        .token = "login",
        .usage = "login [grok] [--import]",
        .summary = "Sign in with Vercel, or with Grok OAuth",
    },
    .{
        .kind = .logout,
        .token = "logout",
        .usage = "logout [grok]",
        .summary = "Sign out of the current Vercel or Grok session",
    },
    .{
        .kind = .setup,
        .token = "setup",
...
pub const top_level_help_groups = [_]TopLevelHelpGroup{
    ...
    .{ .entries = &.{
        .{ .kind = .login, .usage = "login [grok] [--import]" },
        .{ .kind = .logout, .usage = "logout [grok]" },
...
pub const slash_specs = [_]SlashSpec{
    ...
    .{ .kind = .login, .command = "/login", .help_entry = "/login [grok]", .completion_description = "sign in with Vercel or Grok OAuth", .presentation_category = .account, .has_args = true, .accepts_payload = true },
    .{ .kind = .logout, .command = "/logout", .help_entry = "/logout [grok]", .completion_description = "sign out of fx login or Grok OAuth", .presentation_category = .account, .has_args = true, .accepts_payload = true },
