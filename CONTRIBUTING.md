...
`alibaba/qwen` family combines multiple instruction blocks into one leading
system message, preserving their order with two newlines between blocks. Zero
or one instruction is left unchanged; no empty system message is synthesized.
